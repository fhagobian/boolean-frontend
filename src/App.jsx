...
const NuevoCaso = ({onSave,onCancel,loading}) => {
  const [f,setF]=useState({tipo_proceso:"SOPORTE",prioridad:"MEDIUM",descripcion:"",numero_serie:"",rut:"",razon_social:"",departamento:"",localidad:"",direccion:"",telefono:"",rubro:"",criticidad:"NORMAL",empresa_id:"",rango_horario:"Sin restricción",es_incidente:false,incidente_id:"",sla_horas:4,tiene_instrucciones:false,instrucciones_texto:""});
    ...
    <div style={{padding:20,height:"100%",overflowY:"auto"}}>
      ...
      <div className="card" style={{padding:22,maxWidth:860}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:12,marginBottom:18}}>
          ...
          <div><FL label="Criticidad"/><select className="field" value={f.criticidad} onChange={e=>s("criticidad",e.target.value)}>{CRITICIDADES.map(c=><option key={c} value={c}>{c}</option>)}</select></div>
        </div>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16,marginBottom:16}}>
        <div style={{background:B.card,border:`1px solid ${B.border}`,padding:16}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8}}>
            {[["Terminal",caso.numero_serie],["RUT",caso.rut],["Razón Social",caso.razon_social],["Teléfono",caso.telefono],["Rubro",caso.rubro],["Criticidad",caso.criticidad]].map(([l,v])=>v&&(
    ...
    <div>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:20}}>
        ...
        <div style={{display:"flex",gap:9}}>
          <a href="/BOOLEAN_plantilla_carga_masiva.xlsx" download style={{textDecoration:"none"}}>
            <Bb label="⬇ PLANTILLA EXCEL" ghost small color={B.green}/>
          </a>
